...
public class DataBaseUtil {
	...
	private DataBaseUtil() {
		...
		// db연결
		dataSource.setUrl("jdbc:oracle:thin:@" + serverIP +":59161:xe");
		...
		dataSource.setMaxWaitMillis(3000);   // Connection 반납을 기다리는 최대시간 : default 무제한
		dataSource.setMaxIdle(10);		// 최대 대여 가능한 Connection수 : default 8, 음수값을 설정하면 무제한
		dataSource.setMinIdle(5);     // 최소 대여 가능한 Connection수 : default 0
	}
	...
	// SQL오류 Log확인
	public void pirintSQLException(SQLException e, String errLoc) {
