...
public class Main extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		window = primaryStage;
		button[0] = new Button("Button0");
		button[1] = new Button("Button1");
		button[2] = new Button("Button2");
		button[3] = new Button("Button3");
		button[4] = new Button("Button4");
		button[5] = new Button("Button5");
		button[6] = new Button("x");
		button[7] = new Button("x");
		button[8] = new Button("x");
		button[9] = new Button("x");
		...
		button[0].setOnAction(e -> {
			Optional<ButtonType> optional = DialogUtil.dialog1(AlertType.CONFIRMATION, "정보", "친구등록", "친구등록하시겠습니까?");
		...
		button[1].setOnAction(e -> {
			...
			DialogUtil.dialog1(AlertType.CONFIRMATION, "정보", "친구등록", "새로운친구가등록되었습니다.");

		});

		button[2].setOnAction(e -> {
			String value = DialogUtil.textInputDialog("친구아이디를 입력하세요", "친구등록", null, "이메일정보를 입력하세요");
		...
		button[3].setOnAction(e -> {
			...
			String value = DialogUtil.choiceDialog(list, "친구조회", "친구관리", "친구관리", "1234");
...
//	confirmation 사용자 정의 버튼 추가용
		...
		button[5].setOnAction(e -> {
			...
			Optional<ButtonType> optional = DialogUtil.dialog("정보", "친구삭제", "친구목록에서 삭제하시겠습니까?", bt1, bt2, bt3,
					ButtonType.CLOSE);
